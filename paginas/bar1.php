...
<main>
                ...
                <div class="card-body">
                                ...
                                <div class="card shadow-lg border-6 rounded-lg mt-2 card bg-ligth text-dark">
                                    <h6 class="card-header bg-info text-white">AVANCE EJES</h6>
                                <div class="card-body">
                                ...
                                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $result_eje = mysqli_query($mysqli, $query);
                                            while($row = mysqli_fetch_array($result_eje)){?>
                                                <tr style="text-align:justify;">
                                                    
                                                    <td width="25%"><?php echo $row['ejes']?></td>
